// pub fn parse_flight_record_legs(line: &str) -> FlightLegRecord {
//     FlightLegRecord {
//         flight_designator: format!("{}{}{} {} {}", &line[2..5], &line[5..9], &line[1..2], &line[9..11], &line[127..128]),
...
pub fn parse_flight_record_legs(line: &str) -> Option<FlightLegRecord> {
    Some(FlightLegRecord {
        flight_designator: format!(
            "{}{}{} {} {}",
            line[2..5].to_string(), line[5..9].to_string(), line[1..2], line[9..11], line[127..128]
        ),
        operational_suffix: line[1..2].to_string(),
        airline_designator: line[2..5].to_string(),
        flight_number: line[5..9].to_string(),
...
pub fn parse_segment_record(line: &str) -> Option<SegmentRecords>{
    Some(SegmentRecords {
        flight_designator: format!("{}{}{} {} {}", line[2..5].to_string(), line[5..9].to_string(), line[1..2].to_string(), line[9..11].to_string(), line[27..28]).to_string(),
